...
// Task 2
// n tamsayı dizisi verilir. Dizideki maksimum öğenin değerini ve dizinini bulun. İndeksleme 1'den başlar.
//  Çok sayıda maksimum eleman varsa, ilkinin indeksini yazdırın.
// 3 5 -7 7 5 -9 -4
//7 4
// let input = prompt("Ededleri daxil edin:");
// let arr = input.split(" ").map(Number);
...
// Task 6
// n sayda tam ədədlərdən ibarət massiv verilir. Bu massivdə ilk ən kiçik elementi tapıb birinci elementlə
//  yerlərini dəyişin. Digər elementləri olduğu kimi saxlayın.
//6 -3 5 -5 -4 7 -5
//-5 -3 5 6 -4 7 -5
